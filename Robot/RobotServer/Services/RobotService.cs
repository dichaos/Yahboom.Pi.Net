...
#pragma warning disable 1998
        ...
        public override async Task VideoStream(Empty request, IServerStreamWriter<VideoData> responseStream,
        ...
        public override async Task UltrasonicStream(Empty request, IServerStreamWriter<UltrasonicData> responseStream,
            ServerCallContext context)
        {
        ...
        public override async Task AudioStream(Empty request, IServerStreamWriter<AudioData> responseStream,
            ServerCallContext context)
        {
            await _microphone.AudioStream(responseStream, context.CancellationToken);
        }

        public override async Task TrackerStream(Empty request, IServerStreamWriter<TrackerData> responseStream,
            ServerCallContext context)
        {
